...
const trustPolicyThree = {
  ...
  Statement: [
    {
      Sid: 'CostExplorer',
      Action: ['ce:StartSavingsPlansPurchaseRecommendationGeneration', 'ce:UpdatePreferences'],
      Effect: 'Allow',
      Resource: '*',
    },
    {
...
const trustPolicyFour = {
  ...
  Statement: [
    {
      Action: ['cur:ValidateReportDestination', 'cur:DescribeReportDefinitions'],
      Resource: ['*'],
      Effect: 'Allow',
    ...
    },
    {
      ...
      Resource: ['arn:aws:s3:::ck-tuner-275595855473', 'arn:aws:s3:::ck-tuner-275595855473/*'],
      Effect: 'Allow',
      Sid: 'S3LimitedRead',
    },
    {
  ...
  return (
    <div className="onboarding-container">
      ...
      <ol className="onboarding-steps">
        ...
        <li>
          Again, go to the <span className="link-highlight">Create Policy</span> Page.
        </li>
